...
.while_begin:           #     // del ciclo para mayor eficiencia
    ...
    li      a2,0        #     contador 1
    li      a3,0        #     contador 2 
    li      t5,1        #     constante t5=1
.L1:
    and      a6,a0,1    #     a6=a0&1
    bne      a6,t5,.L3  #     if(a6!=t5)   go to .L3
    addi     a2,a2,1    #     a2++
.L3:
    srl      a0,a0,1    #     a0>>1
    bne      a0,zero,.L1 #    do{.L1} while(a0!=0)
.L4:
    and      a7,a1,1     #    a6=a1&1    
    bne      a7,t5,.L6   #    if(a7!=t5) go to .L6
    addi     a3,a3,1     #    a3++
.L6:
    srl      a1,a1,1     #    a1>>1
    bne      a1,zero,.L4 #    do{.L4} while(a1!=0)
.else1:    
    li      t1,0        #     int t1= 0;
    bgeu    a2,a3,.decision  # a0<=a1 equivale a a1>=a0
