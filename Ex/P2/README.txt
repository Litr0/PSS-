...
Ud. debe crear el archivo dividir.c y programar ahí la función dividir.
Ya hay una plantilla de este archivo en dividir.c.plantilla.
...
Entrega de esta pregunta: debe entregar el archivo dividir.c.
